...
static const char *client_commands[] = {"/time", "/stats", "/shutdown", "/help",
                                        NULL};
...
void set_server_users_count(int count) { server_users_count = count; }
...
bool is_command(const char *input) { return input && input[0] == '/'; }